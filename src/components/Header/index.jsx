	...
	return (
		<header className='relative w-full xl:w-[1110px] xl:h-[113px] flex justify-between items-center gap-5 xl:gap-0 border-b border-grayish-blue/50 md:px-0 p-5 z-20'>
			...
			<div className="flex gap-6 lg:gap-[46px] items-center ">
				...
				{
					active && (
						<div className="cart-detail absolute w-full md:w-[360px] h-[256px] bg-white shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] rounded-lg md:top-[5.45rem] md:-right-[4.8rem] top-[6.5rem] -right-full">
								...
								count != 0 ? (
									<div className="p-6 flex flex-col gap-5">
										<div className="flex items-center gap-3">
											...
											<button type='button' onClick={() => setTotal(0)}>
